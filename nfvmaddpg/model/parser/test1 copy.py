...
import pickle
import json
from optimization.parser import Parser, storeParallel, storeOptorder
import pprint
...
request_list_import = pickle.load(StrToBytes(
    open("requestList_" + "complex" + ".pickle", "r")))
...
for i, req in enumerate(request_list):
    ...
    # Chain: req0_a1.req0_u1{req0_u1,req0_u2,req0_u3;req0_u4.req0_u5;3}.req0_u6.req0_a2
    for key, value in parseDict.items():
        # 0      8       16     24      32      40        48        59     67
        print("key: ", key)
        ...
        # 0   8        16      24     32        40    48      56 57    65       74      82      90        100      109
        if isinstance(value, storeParallel):
